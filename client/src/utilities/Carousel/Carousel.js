...
const Carousel = (props) => {
    ...
    if (windowSize.innerWidth <= 1200 && windowSize.innerWidth > 768) {
      show = 2;
    ...
    return (
        <div className="carousel-container ref-y-translate">
            <div className="carousel-wrapper">
                ...
                <div className="carousel-content-wrapper" onTouchStart={handleTouchStart} onTouchMove={handleTouchMove}>
                    <div className={`carousel-content ${carouselCountDisplay}`} style={{transform: `translateX(-${currentIndex * (100 / show)}%)`}}>
                        {children}
                    </div>
                </div>
