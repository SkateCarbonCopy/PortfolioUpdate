            ...
            <div className="container">
                ...
                <div className="row justify-content-end my-lg-5 my-3">
                    <div className='col-lg-9' style={{zIndex: 100}}>
                        ...
                        <h3 className={`${props.theme === 'dark' ? "very-light-blue" : "very-dark-tan"} fw-bold`}>
                            I am&nbsp;
                            <TypeAnimation 
                                sequence={[
                        ...
                        <h5 className={`${props.theme === 'dark' ? "very-light-blue" : "very-dark-tan"} fw-bold`}>I am a highly motivated Web Developer at Hyland Software with a passion for exploring and learning new technologies. I am proficient in AngularJS, JavaScript, HTML, and SCSS. I am always seeking opportunities to expand my technical aptitude, stay current with industry trends, and grow as a professional.</h5>
                    </div>
                </div>
            </div>
        </div>
